...
# By Shakir Luxury Appartments Project Guidelines

## Brand Name
Always write the brand name as **By Shakir Luxury Appartments** (exact format).
...
- Niche/Industry: [e.g., hovenier, tandarts, loodgieter]
- Location (City, Region): [e.g., Culemborg, Gelderland]
- Service Area: [e.g., Rivierenland, heel Nederland]
- Primary Service/Product: [e.g., tuinaanleg en onderhoud]
- Brand assets available: [logo yes/no, brand colors yes/no — if yes, list hex values and font names]
- Photos available: [real team/project photos yes/no]
- Client's personality/vibe: [e.g., warm and approachable, no-nonsense professional, modern and energetic]
